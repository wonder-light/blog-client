...
import { signEncrypt } from '@/assets/js/encrypt'
...
// * http request 拦截器
axios.interceptors.request.use(request, onReject);
...
function request(config) {
    ...
    config.headers.Sign = signEncrypt(env.publicKey, env.privateKey);
