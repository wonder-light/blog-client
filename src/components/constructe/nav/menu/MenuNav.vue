  ...
  <div class="menu-nav">
    ...
    <el-menu active-text-color="#98a6ad" menu-trigger="click" text-color="#98a6ad" unique-opened>
      <el-menu-item index="1" @click="skip('/')">
        <svg-img src="../../../../assets/img/home-page.svg#id-svg"/>
        <p>首页</p>
      </el-menu-item>
      <el-menu-item index="2" @click="skip('/warehouse')">
        <svg-img src="../../../../assets/img/warehouse.svg#id-svg"/>
        <p>仓库</p>
      </el-menu-item>
      <el-menu-item index="3" @click="skip('/album')">
        <svg-img src="../../../../assets/img/album.svg#id-svg"/>
        <p>相册</p>
      </el-menu-item>
      <el-menu-item index="4">
        <svg-img src="../../../../assets/img/music.svg#id-svg"/>
        <p>音乐</p>
      </el-menu-item>
      <el-menu-item index="5" @click="skip('/article')">
        <svg-img src="../../../../assets/img/article.svg#id-svg"/>
        <p>文章</p>
      </el-menu-item>
      <el-menu-item index="6" @click="skip('/archive')">
        <svg-img src="../../../../assets/img/archive.svg#id-svg"/>
        <p>归档</p>
      </el-menu-item>
      <el-sub-menu index="7">
        <template #title>
        ...
        <el-menu-item index="7-2" @click="skip('/guestbook')">
          <svg-img src="../../../../assets/img/guestbook.svg#id-svg"/>
          <p>留言板</p>
        </el-menu-item>
      </el-sub-menu>
    </el-menu>
