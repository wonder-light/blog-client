<template>
    ...
    <div class="side-pane-nav">
        ...
        <el-menu active-text-color="#98a6ad" menu-trigger="click" text-color="#98a6ad" unique-opened>
            ...
            <el-menu-item index="2" @click="$router.push('/warehouse')">
                <svg fill="none" height="16px" stroke="currentColor"
                     stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"
                     width="16px" xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <el-menu-item index="3" @click="$router.push('/album')">
                <svg fill="none" height="16px" stroke="currentColor"
                     stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"
                     width="16px" xmlns="http://www.w3.org/2000/svg">
            ...
            <el-menu-item index="5" @click="$router.push('/article')">
            ...
            <el-menu-item index="6" @click="$router.push('/archive')">
                <svg fill="none" height="16px" stroke="currentColor"
                     stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"
                     width="16px" xmlns="http://www.w3.org/2000/svg">
            ...
            <el-sub-menu index="7">
                ...
                <el-menu-item index="7-1" @click="$router.push('/about')">
                    <svg fill="none" height="16px"
                         stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                         stroke-width="2" viewBox="0 0 24 24" width="16px"
                         xmlns="http://www.w3.org/2000/svg">
                ...
                <el-menu-item index="7-2" @click="$router.push('/guestbook')">
                    <svg fill="none" height="16px" stroke="currentColor"
                         stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"
                         width="16px" xmlns="http://www.w3.org/2000/svg">
